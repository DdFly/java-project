...
public class RegisterEvent {
	...
	public RegisterEvent() {
		...
		register2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(user_register.getCus_Password().compareTo(second_password) != 0) {
					javax.swing.JOptionPane.showMessageDialog(MainMenu.r, "俩次密码输入不相同");
				}
				else if(user_register.getCus_Nickname().compareTo("") == 0||user_register.getCus_Password().compareTo("") == 0||second_password.compareTo("") == 0||user_register.getCus_IDNum().compareTo("") == 0) {
