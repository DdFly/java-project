		...
		button_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if ((textField.getText().equals("10086"))&&(passwordField.getText().equals("123456"))){
					JOptionPane.showMessageDialog(panel,"欢迎使用！", "成功",JOptionPane.INFORMATION_MESSAGE);
				}
				else {
					JOptionPane.showMessageDialog(panel, "密码错误，请重新登录！","错误", JOptionPane.INFORMATION_MESSAGE);
				}
